...
|--------|--------------|---------|
| <Image src={imgDebate} alt="Debate" /> | <Image src={imgCrossDebate} alt="Cross-Debate" /> | <Image src={imgRanking} alt="Ranking" /> |

| Conclusion | Settings |
|------------|----------|
| <Image src={imgConclusion} alt="Conclusion" /> | <Image src={imgSettings} alt="Settings" /> |
